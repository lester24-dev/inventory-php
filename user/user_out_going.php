...
<div class="row g-3">
    ...
    <div class="col-md-6">
      ...
      <input type="text" name="customer_name" class="form-control" id="customer_name" placeholder="Customer Name" style="text-transform: capitalize;" maxlength="50" required>
    </div>
    <br/>
    <br/>
    <div class="col-md-6">
    ...
    <input type="number" name="unit_price" class="form-control" id="unit_price" placeholder="Unity Price" maxlength="8" required>
    </div>
    <div class="col-md-6">
    ...
    <input type="number" name="eoh" class="form-control" id="eoh" placeholder="Enhance On Hand" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Schedule Lot:</label>
    <input type="date" name="schedule_lot" class="form-control" id="schedule_lot" placeholder="Schedule Lot" required>
    </div>
    <div class="col-md-6">
...
<br/>
  <div class="form-group"> 
    ...
    <a href="user_out_going.php" class="btn btn-danger">Close</a>
	</div>
  </div>
</form>
</div>
