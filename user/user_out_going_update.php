...
<div class="container-fluid">
  ...
  <?php
    if (isset($_GET['id'])) {
      ...
      $id = $_GET['id'];
      $stmt = $dbh->prepare("SELECT * FROM out_going WHERE id = '$id'");
      $stmt->execute();
...
<div class="row g-3">
    <div class="col-md-6">
      ...
      <input type="text" name="customer_code" class="form-control" id="customer_code" value="<?php echo $fetch['customer_code'];?>" placeholder="Customer Code" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="3" required>
    </div>
    <div class="col-md-6">
      <label class="control-label" for="username">Customer Name:</label>
      <input type="text" name="customer_name" class="form-control" id="customer_name" style="text-transform: capitalize;" value="<?php echo $fetch['customer_name'];?>" placeholder="Customer Name" maxlength="50" required>
    </div>
    <br/>
    <br/>
    <div class="col-md-6">
      <label class="control-label" for="username">Plate Number:</label>
      <input type="text" name="plate_number" class="form-control" id="plate_number" value="<?php echo $fetch['plate_number'];?>" placeholder="Plate Number" maxlength="10" required>
    </div>
    <div class="col-md-6">
      <label class="control-label" for="username">HAWB:</label>
      <input type="text" name="hawb" class="form-control" id="hawb" placeholder="HAWB" value="<?php echo $fetch['hawb'];?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="12" required>
    </div>
    <div class="col-md-6">
      <label class="control-label" for="username">Airway Bill:</label>
      <input type="text" name="airway_bill" class="form-control" id="airway_bill" value="<?php echo $fetch['airway_bill'];?>" placeholder="Airway Bill" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="12" required>
    </div>
    <div class="col-md-6">
      <label class="control-label" for="username">Peza Ticket:</label>
      <input type="text" name="peza_ticket" class="form-control" id="peza_ticket" value="<?php echo $fetch['peza_ticket'];?>" placeholder="Peza Ticket" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="12" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Trucker:</label>
    <select name="trucker" id="trucker"  class="form-control" required>
		<option value="<?php echo $fetch['trucker'] ?>"><?php echo $fetch['trucker'] ?></option>
    ...
    <div class="col-md-6">
      ...
      <input type="text" name="wafer_run" class="form-control" id="wafer_run" value="<?php echo $fetch['wafer_run'];?>" placeholder="Wafer Run" maxlength="10" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Device Number:</label>
    <input type="text" name="device_number" class="form-control" id="device_number" value="<?php echo $fetch['device_number'];?>" placeholder="Device Number" maxlength="10" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Customer Lot Number:</label>
    <input type="text" name="customer_lot_number" class="form-control" id="customer_lot_number" value="<?php echo $fetch['customer_lot_number'];?>" placeholder="Customer Lot Number"  onkeypress=" return isNumber(event)" maxlength="5" required>
    </div>
    <div class="col-md-6">
    ...
    <select name="country_origin" id="country_origin" class="form-control" required>
		<option value="<?php echo $fetch['country_origin'];?>"><?php echo $fetch['country_origin'];?></option>
    ...
    <select name="plant_site" id="plant_site" class="form-control" required>
		<option value="<?php echo $fetch['plant_site'];?>"><?php echo $fetch['plant_site'];?></option>
    ...
    <input type="text" name="wafer_type" class="form-control" id="wafer_type" value="<?php echo $fetch['wafer_type'];?>" placeholder="Wafer Type" maxlength="10" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Airlines:</label>
    <select name="airlines" id="airlines" class="form-control" required>
		<option value="<?php echo $fetch['airlines'];?>"><?php echo $fetch['airlines'];?></option>
    ...
    <input type="text" name="driver" class="form-control" id="driver" value="<?php echo $fetch['driver'];?>" placeholder="Driver" maxlength="50" required>
    </div>
    <div class="col-md-6">
    ...
    <select name="container_type" id="container_type" class="form-control" required>
		<option value="<?php echo $fetch['container_type'];?>"><?php echo $fetch['container_type'];?></option>
		<option value="Sample 1">Sample 1</option>
		<option value="Sample 2">Sample 2</option>
		</select>
    </div>
    ...
    <input type="number" name="wafer_size" class="form-control" id="wafer_size" value="<?php echo $fetch['wafer_size'];?>" placeholder="Wafer Size" maxlength="8" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Wafer Number:</label>
    <input type="number" name="wafer_number" class="form-control" id="wafer_number" value="<?php echo $fetch['wafer_number'];?>" placeholder="Wafer Number" maxlength="8" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Die QTY:</label>
    <input type="number" name="die_qty" class="form-control" id="die_qty" value="<?php echo $fetch['die_qty'];?>" placeholder="Die QTY" maxlength="8" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">SAWN Date:</label>
    <input type="date" name="sawn_date" class="form-control" id="sawn_date" value="<?php echo $fetch['sawn_date'];?>" placeholder="SAWN Date" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Unit Price:</label>
    <input type="number" name="unit_price" class="form-control" id="unit_price" value="<?php echo $fetch['unit_price'];?>" placeholder="Unity Price" maxlength="8" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">P.O #:</label>
    <input type="number" name="p_o" class="form-control" id="p_o" value="<?php echo $fetch['p_o'];?>" placeholder="P.O#" maxlength="10" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Invoice #:</label>
    <input type="number" name="invoice" class="form-control" id="invoice" value="<?php echo $fetch['invoice'];?>" placeholder="Invoice #" maxlength="8" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Plane Number:</label>
    <input type="text" name="plane_number" class="form-control" id="plane_number" value="<?php echo $fetch['plane_number'];?>" placeholder="Plane Number" maxlength="8" required>
    </div>
    <div class="col-md-6">
    ...
    <select name="number_box" id="number_box" class="form-control" required>
		<option value="<?php echo $fetch['number_box'];?>"><?php echo $fetch['number_box'];?></option>
		<option value="1">1</option>
		<option value="2">2</option>
    <option value="3">3</option>
    <option value="4">4</option>
    ...
    <select name="wafer_qty" id="wafer_qty" class="form-control" required>
		<option value="<?php echo $fetch['wafer_qty'];?>"><?php echo $fetch['wafer_qty'];?></option>
		<option value="1">1</option>
		<option value="2">2</option>
    <option value="3">3</option>
    <option value="4">4</option>
    ...
    <div class="col-md-6">
      ...
      <input type="text" name="customer_info" class="form-control" id="customer_info" value="<?php echo $fetch['customer_info'];?>" placeholder="Customer Info" maxlength="50" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">ETD Date:</label>
    <input type="date" name="edt_date" class="form-control" value="<?php echo $fetch['edt_date'];?>" id="edt_date" placeholder="EDT Date" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">ETD Time:</label>
    <input type="time" name="edt_time" class="form-control" value="<?php echo $fetch['edt_time'];?>" id="edt_time" placeholder="EDT Time" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">ETA Date:</label>
    <input type="date" name="eta_date" class="form-control" value="<?php echo $fetch['eta_date'];?>" id="eta_date" placeholder="ETA Date" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">ETA Time:</label>
    <input type="time" name="eta_time" class="form-control" value="<?php echo $fetch['eta_time'];?>" id="eta_time" placeholder="ETA Time" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">ETC Date:</label>
    <input type="date" name="etc_date" class="form-control" value="<?php echo $fetch['etc_date'];?>" id="etc_date" placeholder="ETC Date" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">ETC Time:</label>
    <input type="time" name="etc_time" class="form-control" value="<?php echo $fetch['etc_time'];?>" id="etc_time" placeholder="ETC Time" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Enhance On Hand:</label>
    <input type="number" name="eoh" class="form-control" id="eoh" value="<?php echo $fetch['eoh'];?>" placeholder="Enhance On Hand" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Schedule Lot:</label>
    <input type="date" name="schedule_lot" class="form-control" id="schedule_lot" value="<?php echo $fetch['schedule_lot'];?>" placeholder="Schedule Lot" required>
    </div>
    <div class="col-md-6">
    <label class="control-label" for="username">Remarks:</label>
    <textarea name="remarks" id="remarks" class="form-control" cols="80" rows="10" required><?php echo $fetch['remarks'];?></textarea>  
    </div>
    <br/>
</div>
<br/>
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" name="out_going_button" class="btn btn-primary">Submit</button>
      <a href="user_out_going_home.php" class="btn btn-danger">Close</a>
	</div>
  </div>
</form>
</div>
...
if (isset($_POST['out_going_button'])) {
  $query = "UPDATE `out_going` SET `customer_code` = :customer_code, `customer_name` = :customer_name, `plate_number` = :plate_number, `hawb` = :hawb, `airway_bill` = :airway_bill, `peza_ticket` = :peza_ticket, `trucker` = :trucker,
  `wafer_run` = :wafer_run, `device_number` = :device_number, `customer_lot_number` = :customer_lot_number, `country_origin` = :country_origin, `plant_site` = :plant_site, `wafer_type` = :wafer_type, `airlines` = :airlines, `driver` = :driver, 
  `container_type` = :container_type, `wafer_size` = :wafer_size, `wafer_number` = :wafer_number, `die_qty` = :die_qty, `sawn_date` = :sawn_date, `unit_price` = :unit_price, `p_o` = :p_o, `invoice` = :invoice, `plane_number` = :plane_number, `number_box` = :number_box,
  `wafer_qty` = :wafer_qty, `customer_info` = :customer_info, `edt_date` = :edt_date, `edt_time` = :edt_time, `eta_date` = :eta_date, `eta_time` = :eta_time	, `etc_date` = :etc_date, `etc_time` = :etc_time, `eoh` = :eoh, `schedule_lot` = :schedule_lot, `remarks` = :remarks WHERE `id` = :id";
  $pdoResult = $dbh->prepare($query);
  $pdoResult->bindParam(":customer_code", $_POST['customer_code']);
  $pdoResult->bindParam(":customer_name", $_POST['customer_name']);
  $pdoResult->bindParam(":plate_number", $_POST['plate_number']);
  $pdoResult->bindParam(":hawb", $_POST['hawb']);
  $pdoResult->bindParam(":airway_bill", $_POST['airway_bill']);
  $pdoResult->bindParam(":peza_ticket", $_POST['peza_ticket']);
  $pdoResult->bindParam(":trucker", $_POST['trucker']);
  $pdoResult->bindParam(":wafer_run", $_POST['wafer_run']);
  $pdoResult->bindParam(":device_number", $_POST['device_number']);
  $pdoResult->bindParam(":customer_lot_number", $_POST['customer_lot_number']);
  $pdoResult->bindParam(":country_origin", $_POST['country_origin']);
  $pdoResult->bindParam(":plant_site", $_POST['plant_site']);
  $pdoResult->bindParam(":wafer_type", $_POST['wafer_type']);
  $pdoResult->bindParam(":airlines", $_POST['airlines']);
  $pdoResult->bindParam(":driver", $_POST['driver']);
  $pdoResult->bindParam(":container_type", $_POST['container_type']);
  $pdoResult->bindParam(":wafer_size", $_POST['wafer_size']);
  $pdoResult->bindParam(":wafer_number", $_POST['wafer_number']);
  $pdoResult->bindParam(":die_qty", $_POST['die_qty']);
  $pdoResult->bindParam(":sawn_date", $_POST['sawn_date']);
  $pdoResult->bindParam(":unit_price", $_POST['unit_price']);
  $pdoResult->bindParam(":p_o", $_POST['p_o']);
  $pdoResult->bindParam(":invoice", $_POST['invoice']);
  $pdoResult->bindParam(":plane_number", $_POST['plane_number']);
  $pdoResult->bindParam(":number_box", $_POST['number_box']);
  $pdoResult->bindParam(":wafer_qty", $_POST['wafer_qty']);
  $pdoResult->bindParam(":customer_info", $_POST['customer_info']);
  $pdoResult->bindParam(":edt_date", $_POST['edt_date']);
  $pdoResult->bindParam(":edt_time", $_POST['edt_time	']);
  $pdoResult->bindParam(":eta_date", $_POST['eta_date']);
  $pdoResult->bindParam(":eta_time", $_POST['eta_time	']);
  $pdoResult->bindParam(":etc_date", $_POST['etc_date']);
  $pdoResult->bindParam(":etc_time", $_POST['etc_time']);
  $pdoResult->bindParam(":eoh", $_POST['eoh']);
  $pdoResult->bindParam(":schedule_lot", $_POST['schedule_lot']);
  $pdoResult->bindParam(":remarks", $_POST['remarks']);
  $pdoResult->bindParam(":id", $_GET['id']);
  $result = $pdoResult->execute();
   header('Location: user_out_going_home.php');
}
