...
<li class="nav-item">
    <a class="nav-link" href="../admin/admin_report.php">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Report</span></a>
</li>

<li class="nav-item">
    <a class="nav-link" href="../admin/admin_history_log.php">
...
<hr class="sidebar-divider d-none d-md-block">
 ...
 <li class="nav-item">
    <a class="nav-link" href="../admin/admin_back_up_data.php">
    <i class="fa fa-undo"></i>
    <span>Back Up Data</span></a>
</li>

<li class="nav-item">
    <a class="nav-link" href="../admin/admin_reset_password.php">
    <i class="fa fa-unlock-alt"></i>
    <span>Reset Password </span></a>
</li>

<li class="nav-item">
    <a class="nav-link" href="../admin/admin_user_register.php">
    <i class="fa fa-user-plus"></i>
    <span>Registration User</span></a>
</li>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
         ...
         <img class='img-profile rounded-circle' src='../uploads/default.png'>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="../teacher/teacher_pass.php">
